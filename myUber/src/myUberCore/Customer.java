...
//Getters & setters
	public long getCounter() {
		return counter;package myUberCore;
...
public class Customer implements Observer{
	...
	private CustomerBalance balance;
	private long creditCard; 
	private Observable booking;
	public Ride ongoingRide; //when booking is confirmed 
...
//Getters & setters
	...
	public Observable getBooking() {
		return booking;
	}
	
	public void setBooking(Observable booking) {
...
//*****************************************************************//	
	...
	public void bookRide(GPS destination ) {
		RideBooking ongoingBooking = new RideBooking(this, destination, this.myUber);
		this.setBooking(ongoingBooking);
	}
	
	public void bookRide(GPS start, GPS destination ) {
		RideBooking ongoingBooking = new RideBooking(this, start, destination, this.myUber);
		this.setBooking(ongoingBooking);
	...
	public void chooseRideType(String type) {
		((RideBooking) this.booking).setRidePreference(type);
		((RideBooking) this.booking).carSearch();
	}
